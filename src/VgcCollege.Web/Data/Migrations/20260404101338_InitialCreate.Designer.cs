...
namespace VgcCollege.Web.Data.Migrations
{
    ...
    [Migration("20260404101338_InitialCreate")]
            ...
            modelBuilder.Entity("VgcCollege.Web.Models.FacultyProfile", b =>
                {
                    b.HasOne("VgcCollege.Web.Models.ApplicationUser", "IdentityUser")
                        .WithOne()
                        .HasForeignKey("VgcCollege.Web.Models.FacultyProfile", "IdentityUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VgcCollege.Web.Models.StudentProfile", b =>
                {
                    b.HasOne("VgcCollege.Web.Models.ApplicationUser", "IdentityUser")
                        .WithOne()
                        .HasForeignKey("VgcCollege.Web.Models.StudentProfile", "IdentityUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
